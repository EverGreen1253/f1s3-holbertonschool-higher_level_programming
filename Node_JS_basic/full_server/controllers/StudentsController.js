  ...
  static getAllStudents(request, response, filename) {
    readDatabase(filename)
      .then((studentsData) => {
        ...
        response.write(`Number of students in CS: ${studentsData.CS.length}. List: ${studentsData.CS.join(', ')}\n`);
        response.end(`Number of students in SWE: ${studentsData.SWE.length}. List: ${studentsData.SWE.join(', ')}`);
      })
      .catch(() => {
